  /**
    ...
    function ReadingTime(numberWordsPerMinute, readigTimeLabel, minutesLabel, wordsLabel, lessThanAMinuteLabel) {
        ...
        const paragraphs = document.querySelectorAll('.'+temp_toc+' p');
        console.log(paragraphs.length+"p lenght");
        // The counter.
        var count = 0;
      ...
      //uncoment for displaying words count  document.querySelector(".reading-time__word-count").innerHTML = '(' + totalWords + ' ' + wordsLabel + ')';
